...
def random_env(Nstates, Nact, seed=None, terminate=False, t_sparsity=0.75):
    ...
    with np_seed(seed):
        ...
        reward = np.random.randn(Nstates,Nact) + reward      #Uncomment for "random_reward_matrix"  setup
        #reward = np.random.randn(Nstates, 1) + reward       #Uncomment for "same_row_values"  setup
