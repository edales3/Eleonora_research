...
if __name__ == "__main__":
    ...
    visitation_probs = compute_visitation(env, learned_q, ent_wt=ent_wt, T=5, discount=discount)
    letseedict = sample_states(env, learned_q, visitation_probs, 50, ent_wt)
    ...
    f = open("stateonly.txt","w")
    f.write(str(adjusted_rew))
    ...
    print('True Reward', env.rew_matrix)
    print('Learned Reward', adjusted_rew)
    fil = open("stateaction.txt", "w")
    fil.write(str(adjusted_rew))
